/*
  ...
  1. New Tables
    ...
    - `footer_settings`
      ...
      - `content` (JSON for flexible footer data)
      - `updated_at` (timestamp)
...
CREATE TABLE IF NOT EXISTS admin_users (
  user_id CHAR(36) PRIMARY KEY REFERENCES auth.users(id) ON DELETE CASCADE,
...
VALUES ('{"text": "© 2025 Stimmungs-Tracker. Alle Rechte vorbehalten.", "links": []}'::JSON)
ON CONFLICT DO NOTHING;
