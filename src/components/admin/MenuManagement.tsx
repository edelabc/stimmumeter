...
export function MenuManagement() {
  ...
  const handleAgreementChange = (agreementId: string | null) => {
    if (agreementId) {
      ...
      if (agreement) {
        // Slug will be auto-generated by database trigger, but we can preview it
        // For now, generate a simple slug from title
        const slug = agreement.titel?.titel
          .toLowerCase()
          .replace(/ä/g, 'ae')
          .replace(/ö/g, 'oe')
          .replace(/ü/g, 'ue')
      ...
      setFormData({
        ...
        linked_agreement_id: null,
        slug: null,
        url: formData.url.startsWith('/docs/') ? '' : formData.url,
      });
    }
  };
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder={formData.linked_agreement_id ? '/docs/...' : 'z.B. /'}
                disabled={!!formData.linked_agreement_id}
              />
              {formData.linked_agreement_id && (
                <p className="text-xs text-blue-600 mt-1">
                  URL wird automatisch generiert. Slug: <code className="bg-blue-50 px-1 rounded">{formData.slug}</code>
                </p>
              )}
            </div>
            {formData.slug && (
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setFormData({
                      ...formData,
                      slug: newSlug,
                      url: formData.linked_agreement_id ? `/docs/${newSlug}` : formData.url,
                    });
                  }}
