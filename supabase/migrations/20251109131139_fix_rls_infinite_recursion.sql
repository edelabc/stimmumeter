...
DROP POLICY IF EXISTS "Public can view public menu items" ON menu_items;
DROP POLICY IF EXISTS "Authenticated users can view public and user menu items" ON menu_items;
DROP POLICY IF EXISTS "Admins can view all menu items in admin panel" ON menu_items;
